/*
Your task is to write a MIPS program that takes as input a number 𝑛>0 and output all its Weird0008 representations.
For example, if 𝑛=5, the output can be:
    5
    41
    32
    311
